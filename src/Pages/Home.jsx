...
const WORDS = ["AI and DataScience Student", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Naveenp7" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/naveen-p-42bb1a256/" },
  { icon: Instagram, link: "https://www.instagram.com/navee.n.?igsh=MWJ5Mjl3cDF0OThiNw==" }
];
